...
public class TestGoods {
	...
	public static void main(String[] args) {
		...
		ArrayList<Good> listGoods = new ArrayList<Good>(Good.getCatalog());
		Collections.sort((List<Good>)listGoods);
		System.out.println(listGoods);
		int locate = Collections.binarySearch((List<Good>)listGoods, paint);
		System.out.println("Found Acme Invisible Paint at location: " + locate);
	}
}
