...
public class TestConversionService {
	...
	public static void main(String[] args) {
		...
		System.out.println(ConversionService.pints(6L)); // Long x Float (precision loss but 6 isn't really a Long anyways)
		System.out.println(ConversionService.pounds(7L));

		// compare these results.  Can you tell why they are different?
		System.out.println("------------------------------------");
		float bigGallons = ConversionService.gallons(123456789123456789L); // Long(64bit) x Float(32bit) (precision loss)
		System.out.println(bigGallons);
		double bigGallons2 = 123456789123456789L * 0.2642; // Long x Double
		System.out.println(bigGallons2);

		System.out.println("------------------------------------");
		int bigGrams = ConversionService.grams(1234567890); // Int x Int (with such big numbers results in overflow and wrong output)
		System.out.println(bigGrams);
		long bigGrams2 = 1234567890L * 1000L; // Long x Long
